...
/**
 * Upload dist/ to:
 *   1) R2 26-vac-test-bid-assets  (project bucket)
 *   2) R2 allworld-sites/26-vac-test-bid/  (shared Allworld host → softwarelink.net)
 */
...
const siteId = process.argv[2] || '26-vac-test-bid'
const projectBucket = '26-vac-test-bid-assets'
